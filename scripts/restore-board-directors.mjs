...
const allowedSlugs = directors.map((director) => director.slug);

await prisma.boardDirector.updateMany({
  where: {
    slug: {
      notIn: allowedSlugs,
    },
...
console.log("Restored 8 board directors and hidden extra test entries.");
